...
const ToolsCard = ({ tool, selected, setSelected }) => {
    // console.log(tool)
        ...
        <div>
            <div className="flex flex-col justify-between h-full card w-96 bg-base-100 card-lg shadow-lg">
                <div className="card-body">
                    ...
                    <button onClick={() => { handleSelected(tool); setSelectbtn(true);toast.success("Tools Added!") }} className={`btn ${selectBtn === true ? "bg-green-500" : "bg-linear-to-r from-[#4F39F6] to-[#9514FA]"} text-white  rounded-full`}> {selectBtn === true ? (<> <FaCheck /> Added to cart </>) : ("Buy Now")} </button>
